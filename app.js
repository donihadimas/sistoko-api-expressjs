...
console.log(`DeHoli SuperApp Backend listening on port  ${process.env.NODE_ENV == "production_local" ? process.env.BASE_URL : "production" ? process.env.BASE_URL_PROD : process.env.BASE_URL_DEV + ":" + process.env.PORT}`);
module.exports = app;
